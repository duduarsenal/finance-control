            ...
            <div className="bg-brand-black px-1 w-[400px] h-[150px] rounded-lg outline outline-solid outline-[1px] outline-brand-gray py-2 flex flex-col items-center justify-center gap-5">
                ...
                <div className="flex items-center justify-around w-full">
                    <Button 
                        ...
                        className="my-0 bg-brand-dark-white w-[125px] py-1 rounded-sm text-[18px] text-brand-black outline outline-[1px] outline-brand-black hover:scale-[1.03] transition-all hover:bg-brand-dark-white"
                    />
                    <Button 
                        value={option2}
                        handleButton={action2} 
                        className="my-0 bg-brand-black w-[125px] px-2 rounded-sm py-1 text-[18px] outline outline-[1px] outline-brand-gray hover:scale-[1.03] transition-all"
                    />
                </div>
            </div>
        </div>
